...
const TermsOfService = () => {
  return (
    ...
    >
      ...
      <p>
        <strong>
          Our Terms of Services were Last updated on May 29, 2025.
        </strong>
      </p>
      <p>
      ...
      <h3>Definitions</h3>
      <p>For the purposes of these Terms of Services:</p>
      <ul>
        <li>
        ...
        <li>
          <strong>“Account”</strong> means your unique profile created to access
          our Service or its featuresmeans a unique account created for You to
          access our Service or parts of our Service.
        </li>
        <li>
          <strong>“Company”</strong> (referred to as either &quot;the
          Company&quot;, &quot;We&quot;, &quot;Us&quot;, or &quot;Our&quot;. in
          this Agreement) refers to Aspireq.
        </li>
        <li>
          <strong>“Country”</strong>refer to India.
        </li>
        <li>
        ...
        <li>
          <strong>“Terms Of Services”</strong> (also referred as
          &quot;Terms&quot;) mean these Terms of Service that form the entire
          agreement between You and the Company regarding the use of the
          Service. This Terms of Service Agreement was generated by TermsFeed
        ...
        <li>
          <strong>“Website”</strong> means Aspireq&apos;s official site
          accessible at{" "}
          <a
            href="https://www.aspireqlearning.co.in"
            target="_blank"
            rel="noopener noreferrer"
            style={{ color: "#007BFF" }}
          >
            https://www.aspireqlearning.co.in
          </a>
          .
        </li>
        <li>
      ...
      <ul>
        ...
        <li>Impersonation of others, including the Company.</li>
        <li>
      ...
      <p>
        ...
        state.You agree to maintain a complete and accurate copy of any Content
      ...
      <p>
        ...
        <a href="mailto:info@aspireq.in" style={{ color: "#007BFF" }}>
          info@aspireq.in
        </a>{" "}
      ...
      <p>
        You can contact our copyright agent via email (info@aspireq.in). Upon
      ...
      <p>
        ...
        the Country and foreign countrie
      </p>
      <p>
      ...
      <p>
        We grant you a limited, non-exclusive license to use the Service in
        compliance with these Terms.
      </p>
      <p>
        You must not use the Service for illegal purposes or to violate any
        applicable laws.
      </p>
      ...
      <h2>&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaime&quot;</h2>
      <p>
      ...
      <h2>Translation</h2>
      <p>
        If these Terms are translated, the English version shall prevail in case
        of conflict.
      </p>
